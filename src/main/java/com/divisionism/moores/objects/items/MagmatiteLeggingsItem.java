...
public class MagmatiteLeggingsItem extends ArmorItem {
	...
	public MagmatiteLeggingsItem(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public void inventoryTick(ItemStack stack, World worldIn, Entity entityIn, int itemSlot, boolean isSelected) {
		...
		if (this.getDamage(stack) == this.getMaxDamage(stack) - 1) {
			...
			leggings.setDamage(initialDamage);
			player.inventory.setInventorySlotContents(37, leggings);
